...
func TestFibonacci(t *testing.T) {
	...
	one.SetOne()
	system.RegisterConstraint(cs.BuildLocalConstraint(colA, sym.NewConst(zero), 0, N))
	system.RegisterConstraint(cs.BuildLocalConstraint(colB, sym.NewConst(one), 0, N))
