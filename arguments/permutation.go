...
func equalityUpToPermutationIOP(system *cs.Builder, E1, E2 []expr.Expr) error {
	...
	system.RegisterDerivationStep(append(E1, E2...), []string{gamma}, proveractions.NewIDCtx(proveractions.FIAT_SHAMIR))
	...
	system.RegisterDerivationStep([]expr.Expr{E1MinusGamma, E2MinusGamma}, []string{IDGrandProduct}, proveractions.NewIDCtx(proveractions.GRAND_PRODUCT))
...
func multiSetPermutation(system *cs.Builder, E1, E2 [][]expr.Expr) error {
	...
	system.RegisterDerivationStep(deps, []string{alpha}, proveractions.NewIDCtx(proveractions.FIAT_SHAMIR))
