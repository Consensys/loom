...
var (
	...
	fsHasher     = flag.String("fs-hash", "poseidon2", "fs-hash: poseidon2 | sha256 | blake3")
	hashName     = flag.String("hash", fri.HashBackendPoseidon2, "hash backend: poseidon2 | sha256 | blake3")
