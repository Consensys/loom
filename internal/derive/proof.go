...
type Proof struct {
	...
	// List of TranscriptRounds, simulating a \Sigma protocol.
	// The last challenge derive is always the evaluation point, and the last binded poly is the quotient.
	// The list of TranscriptRounds is seen as a DAG whose nodes are {inputs: DependenciesChallenges, output: challengeName}.
